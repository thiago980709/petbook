...
describe('ImageGalleryComponent', () => {
  ...
  beforeEach(() => {
    //spy = spyOn(imgService,'getImages').and.returnValues([{ "id": 1, "brand": "perro", "url": "assets/images/perro1.jpg" },{ "id": 5, "brand": "perro", "url": "assets/images/perro3.jpg" }])
  ...
  describe('Validacion Lista Mascotas',()=>{
    it('Cuando se obtenga la lista se debe cargar la informacion en el orden estipulado', () => {
